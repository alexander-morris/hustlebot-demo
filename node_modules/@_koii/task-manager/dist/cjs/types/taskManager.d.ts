...
type AuditFunction = (submission: string, roundNumber: number, submitter_pubkey: string) => Promise<boolean | void>;
type DistributionFunction = (submitters: Submitter[], bounty: number, roundNumber: number) => DistributionList;

...
class Distribution {
    constructor() {
        ...
        this.submitDistributionList = (round) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const decider = yield namespace_wrapper_1.namespaceWrapper.uploadDistributionList(distributionList, round);
                console.log("DECIDER", decider);
                if (decider) {
                    const response = yield namespace_wrapper_1.namespaceWrapper.distributionListSubmissionOnChain(round);
        ...
        this.validateDistribution = (distributionListSubmitter, round, _nodePublicKey) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const rawDistributionList = yield namespace_wrapper_1.namespaceWrapper.getDistributionList(distributionListSubmitter, round);
    ...
    selectAndGenerateDistributionList(round_1) {
        return __awaiter(this, arguments, void 0, function* (round, isPreviousRoundFailed = false) {
            ...
            yield namespace_wrapper_1.namespaceWrapper.selectAndGenerateDistributionList(this.submitDistributionList, round, isPreviousRoundFailed);
        });
    }
    /**
    ...
    auditDistribution(round) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield namespace_wrapper_1.namespaceWrapper.validateAndVoteOnDistributionList(this.validateDistribution, round);
        });
    }
    /**
    ...
    generateDistributionList(round) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                try {
                    taskAccountDataJSON =
                        yield namespace_wrapper_1.namespaceWrapper.getTaskSubmissionInfo(round);
                    taskStakeListJSON = yield namespace_wrapper_1.namespaceWrapper.getTaskState({
